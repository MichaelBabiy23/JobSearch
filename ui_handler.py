...
def create_ui(
    ...
    ttk.Label(main_frame, text="Example: Node.js developer in New-York,USA").grid(row=1, column=2, padx=10, pady=5,
                                                                                  sticky="w")

    ttk.Label(main_frame, text="Free-form job search query. Include job title and location.").grid(row=2, column=1,
                                                                                                   padx=10, pady=5,
                                                                                                   sticky="w")
    ...
    ttk.Label(main_frame, text="City, country, or any other locations.").grid(row=4, column=1, padx=10, pady=5,
                                                                              sticky="w")
    ...
    ttk.Label(main_frame, text="Distance to the location in kilometers. Leave blank for all distances.").grid(row=6,
                                                                                                              column=1,
                                                                                                              padx=10,
                                                                                                              pady=5,
                                                                                                              sticky="w")
    ...
    ttk.Label(main_frame, text="Language for return fields (location, employmentType, etc.).").grid(row=8, column=1,
                                                                                                    padx=10, pady=5,
                                                                                                    sticky="w")
    ...
    ttk.Label(main_frame, text="Allowed values: month, week, today, 3days").grid(row=10, column=1, padx=10, pady=5,
                                                                                 sticky="w")
    ...
    ttk.Label(main_frame, text="Find remote jobs only (work from home).").grid(row=12, column=1, padx=10, pady=5,
                                                                               sticky="w")
    ...
    ttk.Label(main_frame, text="Only receive job postings from specific job providers.").grid(row=14, column=1, padx=10,
                                                                                              pady=5, sticky="w")
    ...
    ttk.Label(main_frame, text="FULLTIME, CONTRACTOR, PARTTIME, INTERN").grid(row=16, column=1, padx=10, pady=5,
                                                                              sticky="w")
    ...
    ttk.Label(main_frame, text="Index of the search. Maximum 10 jobs per request.").grid(row=18, column=1, padx=10,
                                                                                         pady=5, sticky="w")
    ...
    send_button = ttk.Button(main_frame, text="Send API Request and Notify (Email & Telegram)",
                             command=request_and_notify)
